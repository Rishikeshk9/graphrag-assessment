        ...
        return RetrievalResponse(
            ...
            child_citations=[
                Citation(
                    ...
                    source_id="microsoft-email",
                    excerpt="Microsoft acquired Activision Blizzard.",
                )
            ],
            parent_contexts=[
                ParentContext(
                    parent_chunk_id="parent-1",
                    source_id="microsoft-email",
                    text="The announcement confirms Microsoft acquired Activision Blizzard.",
            ...
            graph_triples=[
                GraphTriple(
                    ...
                    source_parent_chunk_id="parent-1",
                    source_child_chunk_id="child-1",
                    source_id="microsoft-email",
...
def test_evaluation_scores_source_graph_and_provenance() -> None:
    ...
    result = asyncio.run(EvaluationService(FakeRetrieval()).evaluate(request))
